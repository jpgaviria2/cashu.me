package me.bitpoints.wallet.noise

import android.content.Context
import android.util.Log
import me.bitpoints.wallet.identity.SecureIdentityStateManager
import me.bitpoints.wallet.mesh.PeerFingerprintManager
import me.bitpoints.wallet.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = me.bitpoints.wallet.noise.southernstorm.protocol.Noise.createDH("25519")
     ...
     */
    fun signPacket(packet: me.bitpoints.wallet.protocol.BitchatPacket): me.bitpoints.wallet.protocol.BitchatPacket? {
     ...
     */
    fun verifyPacketSignature(packet: me.bitpoints.wallet.protocol.BitchatPacket, publicKey: ByteArray): Boolean {
