...
class BluetoothGattServerManager(
    ...
    fun start(): Boolean {
        ...
        try {
            if (!me.bitpoints.wallet.ui.debug.DebugSettingsManager.getInstance().gattServerEnabled.value) {
    ...
    private fun startAdvertising() {
        // Respect debug setting
        val enabled = try { me.bitpoints.wallet.ui.debug.DebugSettingsManager.getInstance().gattServerEnabled.value } catch (_: Exception) { true }
