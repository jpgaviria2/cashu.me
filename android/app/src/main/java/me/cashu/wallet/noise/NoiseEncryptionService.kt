package me.cashu.wallet.noise

import android.content.Context
import android.util.Log
import me.cashu.wallet.identity.SecureIdentityStateManager
import me.cashu.wallet.mesh.PeerFingerprintManager
import me.cashu.wallet.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = me.cashu.wallet.noise.southernstorm.protocol.Noise.createDH("25519")
