...
class BluetoothGattServerManager(
    ...
    fun start(): Boolean {
        ...
        try {
            if (!me.cashu.wallet.ui.debug.DebugSettingsManager.getInstance().gattServerEnabled.value) {
    ...
    private fun startAdvertising() {
        // Respect debug setting
        val enabled = try { me.cashu.wallet.ui.debug.DebugSettingsManager.getInstance().gattServerEnabled.value } catch (_: Exception) { true }
